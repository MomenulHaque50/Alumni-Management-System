	...
	margin:unset;
        ...
        <header class="masthead">
		            ...
		            <div class="row">
		                <div class="col-md-8">
		                    <div class="input-group mb-3">
		                      ...
		                      <input type="text" class="form-control" id="filter" placeholder="Filter Student ID, Name, Subject, Batch etc." aria-label="Filter" aria-describedby="filter-field">
		                    </div>
		                </div>
		                <div class="col-md-4">
            ...
            <div class="container-fluid mt-3 pt-2">
                ...
                $alumni = $conn->query("SELECT a.*,c.course,fullname as name from alumnus_bio a inner join courses c on c.id = a.course_id order by fullname asc");
                ...
                <div class="card alumni-list" data-id="<?php echo $row['id'] ?>">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="">
                                <div>
                                <p class="filter-txt" ><a style="text-decoration: none; color: blue;" href="profile.php?vhid=<?php echo $row['id'];?>"><b><?php echo $row['name'] ?></b></a></p>
                                <hr class="divider w-100" style="max-width: calc(100%)">
								<p class="filter-txt">Student ID: <b><?php echo $row['stuid'] ?></b></p>
                                <p class="filter-txt">Email: <b><?php echo $row['email'] ?></b></p>
                                <p class="filter-txt">Subject: <b><?php echo $row['course'] ?></b></p>
                                <p class="filter-txt">Batch: <b><?php echo $row['batch'] ?></b></p>
                                <p class="filter-txt">Currently Connected to: <b><?php echo $row['position'] ?>-<?php echo $row['institutionname'] ?></b></p>
                                    <br>
                                </div>
                            </div>
                        </div>
